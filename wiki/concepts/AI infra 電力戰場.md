...
| **[[NRG Energy]]**（NYSE: NRG）⭐ **#J1 2026-06-09 補位 utility-first IPP + retail anchor** | **美國第二大 retail electricity + ERCOT firm power 氣電 + Vivint Smart Home 整合** | **~17 GW**（氣電 + 燃煤 + 太陽能 + 儲能）+ **8M retail users**（Reliant + Green Mountain + Cirro）+ Vivint 230 萬訂閱戶 | **無已公開大型 hyperscaler PPA**（vs CEG / VST / TLN）但 ERCOT data center retail / wholesale 間接受惠 + Forward PE 12-16x **估值最便宜** |
| **[[Public Service Enterprise Group]]**（NYSE: PEG / PSEG）⭐ **#J1 2026-06-09 補位 utility-anchored + 核電 niche** | **新澤西最大 utility（2.4M 電力 + 1.9M 天然氣）+ 核電 fleet 3,750MW（Salem 1 / 2 + Hope Creek）+ 海上風電 ramp** | **utility 80% + 核電 3.75 GW + 氣電 ~5 GW + 海上風電 Ocean Wind 2 + Atlantic Shores（2027-2030 ramp）** | **無已公開大型 hyperscaler PPA**、Salem 核電 PSEG 57% + Constellation 43% 共同持股 anchor、Forward PE 18-22x 中間估值 |
| **[[Duke Energy]]**（NYSE: DUK）⭐ **#J1 2026-06-09 補位 美東南 utility 龍頭 + 核電 fleet utility-owned #2** | **跨北卡 + 南卡 + 佛州 + 印第安納 + 俄亥俄 + 肯塔基六州（8.4M 電力 + 1.6M 天然氣 utility 客戶）+ 核電 fleet 6 站 ~10GW（McGuire + Catawba + Oconee + Brunswick + Harris + Robinson）** | **utility 95% + 核電 ~10 GW + 30+ GW 多元（核電 + 燃煤 + 氣電 + 太陽能 + 風電）+ AI 資料中心 Google / Microsoft / AWS 北卡 + 南卡 + 佛州 hub 客戶間接受惠** | **無已公開大型 PPA**（但有 data center retail / wholesale 客戶外溢）+ Forward PE 16-20x **最便宜 + utility 客戶規模最大** |
